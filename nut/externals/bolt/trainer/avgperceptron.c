/* Generated by Cython 0.14.1 on Fri Apr  8 10:27:41 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__bolt__trainer__avgperceptron
#include "stdio.h"
#include "stdlib.h"
...
/* "bolt/trainer/avgperceptron.pyx":27
 * # ----------------------------------------
 * 
 * cdef struct Pair:             # <<<<<<<<<<<<<<
 *     np.uint32_t idx
...
struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair {
  __pyx_t_5numpy_uint32_t idx;
  __pyx_t_5numpy_float32_t val;
};

/* "bolt/trainer/avgperceptron.pyx":67
 *     return max_j
 * 
...
struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron {
  PyObject_HEAD
  struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron *__pyx_vtab;
  int epochs;
};


struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron {
  void (*_train_multi)(struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *);
};
static struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron *__pyx_vtabptr_4bolt_7trainer_13avgperceptron_AveragedPerceptron;
...
/* Module declarations from bolt.trainer.avgperceptron */

static PyTypeObject *__pyx_ptype_4bolt_7trainer_13avgperceptron_AveragedPerceptron = 0;
static double __pyx_f_4bolt_7trainer_13avgperceptron_dot(double *, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *, int); /*proto*/
static void __pyx_f_4bolt_7trainer_13avgperceptron_add(double *, int, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *, int, int, double, double *, double); /*proto*/
static int __pyx_f_4bolt_7trainer_13avgperceptron_argmax(double *, int, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *, int, int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), 'R' };
#define __Pyx_MODULE_NAME "bolt.trainer.avgperceptron"
static int __pyx_module_is_main_bolt__trainer__avgperceptron = 0;

/* Implementation of bolt.trainer.avgperceptron */
...
/* "bolt/trainer/avgperceptron.pyx":31
 *     np.float32_t val
 * 
...
static  double __pyx_f_4bolt_7trainer_13avgperceptron_dot(double *__pyx_v_w, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_nnz) {
  double __pyx_v_sum;
  struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair __pyx_v_pair;
  int __pyx_v_i;
  double __pyx_r;
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("dot");

  /* "bolt/trainer/avgperceptron.pyx":34
 *     """Dot product of weight vector w and example x.
 *     """
 *     cdef double sum = 0.0             # <<<<<<<<<<<<<<
 *     cdef Pair pair
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":37
 *     cdef Pair pair
 *     cdef int i
 *     for i from 0 <= i < nnz:             # <<<<<<<<<<<<<<
 *         pair = x[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "bolt/trainer/avgperceptron.pyx":38
 *     cdef int i
 *     for i from 0 <= i < nnz:
 *         pair = x[i]             # <<<<<<<<<<<<<<
 *         sum += w[pair.idx] * pair.val
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":39
 *     for i from 0 <= i < nnz:
 *         pair = x[i]
 *         sum += w[pair.idx] * pair.val             # <<<<<<<<<<<<<<
 *     return sum
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":40
 *         pair = x[i]
 *         sum += w[pair.idx] * pair.val
 *     return sum             # <<<<<<<<<<<<<<
 * 
...
/* "bolt/trainer/avgperceptron.pyx":42
 *     return sum
 * 
 * cdef void add(double *w, int stride, Pair *x, int nnz, int y,             # <<<<<<<<<<<<<<
...
static  void __pyx_f_4bolt_7trainer_13avgperceptron_add(double *__pyx_v_w, int __pyx_v_stride, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_nnz, int __pyx_v_y, double __pyx_v_c, double *__pyx_v_wbar, double __pyx_v_u) {
  struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair __pyx_v_pair;
  int __pyx_v_i;
  int __pyx_v_offset;
  int __pyx_t_1;
  ...
  /* "bolt/trainer/avgperceptron.pyx":46
 *     cdef Pair pair
 *     cdef int i
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":47
 *     cdef int i
 *     cdef int offset = (y*stride)
 *     for i from 0 <= i < nnz:             # <<<<<<<<<<<<<<
 *         pair = x[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "bolt/trainer/avgperceptron.pyx":48
 *     cdef int offset = (y*stride)
 *     for i from 0 <= i < nnz:
 *         pair = x[i]             # <<<<<<<<<<<<<<
 *         w[offset + pair.idx] += (pair.val * c)
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":49
 *     for i from 0 <= i < nnz:
 *         pair = x[i]
 *         w[offset + pair.idx] += (pair.val * c)             # <<<<<<<<<<<<<<
 *         wbar[offset + pair.idx] += (c*u*pair.val)
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":50
 *         pair = x[i]
 *         w[offset + pair.idx] += (pair.val * c)
 *         wbar[offset + pair.idx] += (c*u*pair.val)             # <<<<<<<<<<<<<<
 * 
...
/* "bolt/trainer/avgperceptron.pyx":52
 *         wbar[offset + pair.idx] += (c*u*pair.val)
 * 
 * cdef int argmax(double *w, int wstride, Pair *x, int xnnz, int y, int k):             # <<<<<<<<<<<<<<
 *     cdef Pair pair
...
static  int __pyx_f_4bolt_7trainer_13avgperceptron_argmax(double *__pyx_v_w, int __pyx_v_wstride, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_xnnz, int __pyx_v_y, int __pyx_v_k) {
  int __pyx_v_j;
  double *__pyx_v_wk;
  ...
  /* "bolt/trainer/avgperceptron.pyx":56
 *     cdef int j
 *     cdef double *wk
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":57
 *     cdef double *wk
 *     cdef double max_score = -1.0
 *     cdef double p = 0.0             # <<<<<<<<<<<<<<
 *     cdef int max_j = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":58
 *     cdef double max_score = -1.0
 *     cdef double p = 0.0
 *     cdef int max_j = 0             # <<<<<<<<<<<<<<
 *     for j from 0 <= j < k:
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":59
 *     cdef double p = 0.0
 *     cdef int max_j = 0
 *     for j from 0 <= j < k:             # <<<<<<<<<<<<<<
 *         wk = w + (wstride*j)
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "bolt/trainer/avgperceptron.pyx":60
 *     cdef int max_j = 0
 *     for j from 0 <= j < k:
 *         wk = w + (wstride*j)             # <<<<<<<<<<<<<<
 *         p = dot(wk, x, xnnz)
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":61
 *     for j from 0 <= j < k:
 *         wk = w + (wstride*j)
 *         p = dot(wk, x, xnnz)             # <<<<<<<<<<<<<<
 *         if p >= max_score:
 *             max_j = j
 */
    __pyx_v_p = __pyx_f_4bolt_7trainer_13avgperceptron_dot(__pyx_v_wk, __pyx_v_x, __pyx_v_xnnz);

    /* "bolt/trainer/avgperceptron.pyx":62
 *         wk = w + (wstride*j)
 *         p = dot(wk, x, xnnz)
 *         if p >= max_score:             # <<<<<<<<<<<<<<
 *             max_j = j
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "bolt/trainer/avgperceptron.pyx":63
 *         p = dot(wk, x, xnnz)
 *         if p >= max_score:
 *             max_j = j             # <<<<<<<<<<<<<<
 *             max_score = p
 ...
 */
      ...
      /* "bolt/trainer/avgperceptron.pyx":64
 *         if p >= max_score:
 *             max_j = j
 *             max_score = p             # <<<<<<<<<<<<<<
 *     return max_j
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":65
 *             max_j = j
 *             max_score = p
 *     return max_j             # <<<<<<<<<<<<<<
 * 
...
/* "bolt/trainer/avgperceptron.pyx":79
 *     cdef int epochs
 * 
...
static int __pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__[] = "        \n        :arg epochs: The number of iterations through the dataset.\n        :type epochs: int\n        ";
struct wrapperbase __pyx_wrapperbase_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__;
static int __pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("bolt.trainer.avgperceptron.AveragedPerceptron.__init__");
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;

  /* "bolt/trainer/avgperceptron.pyx":84
 *         :type epochs: int
 *         """
 *         self.epochs = epochs             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  ((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)__pyx_v_self)->epochs = __pyx_t_1;
...
/* "bolt/trainer/avgperceptron.pyx":87
 * 
 * 
...
static PyObject *__pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train[] = "Train `model` on the `dataset` using SGD.\n\n        :arg model: The model that is going to be trained.\n        Either :class:`bolt.model.GeneralizedLinearModel` or\n        :class:`bolt.model.LinearModel`.\n        :arg dataset: The :class:`bolt.io.Dataset`. \n        :arg verbose: The verbosity level. If 0 no output to stdout.\n        :arg shuffle: Whether or not the training data should be\n        shuffled after each epoch.\n        :arg seed: The seed for the random number generator to reproduce shufflings.\n        ";
static PyObject *__pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("bolt.trainer.avgperceptron.AveragedPerceptron.train");
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;

  /* "bolt/trainer/avgperceptron.pyx":99
 *         :arg seed: The seed for the random number generator to reproduce shufflings.
 *         """
 ...
 */
  ...
  ((struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)__pyx_v_self)->__pyx_vtab)->_train_multi(((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)__pyx_v_self), __pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5);
...
/* "bolt/trainer/avgperceptron.pyx":101
 *         self._train_multi(model, dataset, verbose, shuffle, seed)
 * 
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle, seed):             # <<<<<<<<<<<<<<
 *         cdef int m = model.m
...
static  void __pyx_f_4bolt_7trainer_13avgperceptron_18AveragedPerceptron__train_multi(struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *__pyx_v_self, PyObject *__pyx_v_model, PyObject *__pyx_v_dataset, PyObject *__pyx_v_verbose, PyObject *__pyx_v_shuffle, PyObject *__pyx_v_seed) {
  int __pyx_v_m;
  int __pyx_v_k;
  int __pyx_v_n;
  int __pyx_v_length;
  ...
  struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_xdata;
  float __pyx_v_y;
  int __pyx_v_z;
  int __pyx_v_xnnz;
  int __pyx_v_nadds;
  ...
  /* "bolt/trainer/avgperceptron.pyx":102
 * 
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle, seed):
 *         cdef int m = model.m             # <<<<<<<<<<<<<<
 *         cdef int k = model.k
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":103
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle, seed):
 *         cdef int m = model.m
 *         cdef int k = model.k             # <<<<<<<<<<<<<<
 *         cdef int n = dataset.n
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":104
 *         cdef int m = model.m
 *         cdef int k = model.k
 *         cdef int n = dataset.n             # <<<<<<<<<<<<<<
 *         cdef int length = k*m
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":105
 *         cdef int k = model.k
 *         cdef int n = dataset.n
 *         cdef int length = k*m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":107
 *         cdef int length = k*m
 * 
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":109
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W
 *         # maintain a averaged w
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),             # <<<<<<<<<<<<<<
 *                                                                         dtype=np.float64)
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":110
 *         # maintain a averaged w
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),
 *                                                                         dtype=np.float64)             # <<<<<<<<<<<<<<
 *         cdef double *wdata = <double *>w.data
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":111
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),
 *                                                                         dtype=np.float64)
 *         cdef double *wdata = <double *>w.data             # <<<<<<<<<<<<<<
 *         cdef double *wbardata = <double *>wbar.data
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":112
 *                                                                         dtype=np.float64)
 *         cdef double *wdata = <double *>w.data
 *         cdef double *wbardata = <double *>wbar.data             # <<<<<<<<<<<<<<
 *         cdef int wstride0 = w.strides[0]
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":113
 *         cdef double *wdata = <double *>w.data
 *         cdef double *wbardata = <double *>wbar.data
 *         cdef int wstride0 = w.strides[0]             # <<<<<<<<<<<<<<
 *         cdef int wstride1 = w.strides[1]
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":114
 *         cdef double *wbardata = <double *>wbar.data
 *         cdef int wstride0 = w.strides[0]
 *         cdef int wstride1 = w.strides[1]             # <<<<<<<<<<<<<<
 *         cdef int wstride = <int> (wstride0 / wstride1)
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":115
 *         cdef int wstride0 = w.strides[0]
 *         cdef int wstride1 = w.strides[1]
 *         cdef int wstride = <int> (wstride0 / wstride1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":118
 * 
 *         # training instance
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":119
 *         # training instance
 *         cdef np.ndarray x = None
 *         cdef Pair *xdata = NULL             # <<<<<<<<<<<<<<
 *         cdef float y = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":120
 *         cdef np.ndarray x = None
 *         cdef Pair *xdata = NULL
 *         cdef float y = 0             # <<<<<<<<<<<<<<
 *         cdef int z = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":121
 *         cdef Pair *xdata = NULL
 *         cdef float y = 0
 *         cdef int z = 0             # <<<<<<<<<<<<<<
 *         cdef int xnnz = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":122
 *         cdef float y = 0
 *         cdef int z = 0
 *         cdef int xnnz = 0             # <<<<<<<<<<<<<<
 *         cdef int nadds = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":123
 *         cdef int z = 0
 *         cdef int xnnz = 0
 *         cdef int nadds = 0             # <<<<<<<<<<<<<<
 *         cdef int i = 0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":124
 *         cdef int xnnz = 0
 *         cdef int nadds = 0
 *         cdef int i = 0             # <<<<<<<<<<<<<<
 *         cdef int E = self.epochs
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":125
 *         cdef int nadds = 0
 *         cdef int i = 0
 *         cdef int E = self.epochs             # <<<<<<<<<<<<<<
 *         cdef double u = 0.0
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":126
 *         cdef int i = 0
 *         cdef int E = self.epochs
 *         cdef double u = 0.0             # <<<<<<<<<<<<<<
 *         t1=time()
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":127
 *         cdef int E = self.epochs
 *         cdef double u = 0.0
 *         t1=time()             # <<<<<<<<<<<<<<
 *         for e from 0 <= e < E:
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":128
 *         cdef double u = 0.0
 *         t1=time()
 *         for e from 0 <= e < E:             # <<<<<<<<<<<<<<
 *             if verbose > 0:
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_2; __pyx_t_9++) {
    ...
    /* "bolt/trainer/avgperceptron.pyx":129
 *         t1=time()
 *         for e from 0 <= e < E:
 *             if verbose > 0:             # <<<<<<<<<<<<<<
 *                 print("-- Epoch %d" % (e+1))
 ...
 */
    ...
    if (__pyx_t_10) {
      ...
      /* "bolt/trainer/avgperceptron.pyx":130
 *         for e from 0 <= e < E:
 *             if verbose > 0:
 *                 print("-- Epoch %d" % (e+1))             # <<<<<<<<<<<<<<
 *             if shuffle:
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":131
 *             if verbose > 0:
 *                 print("-- Epoch %d" % (e+1))
 *             if shuffle:             # <<<<<<<<<<<<<<
 *                 dataset.shuffle(seed=seed)
 ...
 */
    ...
    if (__pyx_t_10) {
      ...
      /* "bolt/trainer/avgperceptron.pyx":132
 *                 print("-- Epoch %d" % (e+1))
 *             if shuffle:
 *                 dataset.shuffle(seed=seed)             # <<<<<<<<<<<<<<
 *             nadds = 0
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":133
 *             if shuffle:
 *                 dataset.shuffle(seed=seed)
 *             nadds = 0             # <<<<<<<<<<<<<<
 *             i = 0
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":134
 *                 dataset.shuffle(seed=seed)
 *             nadds = 0
 *             i = 0             # <<<<<<<<<<<<<<
 *             for x,y in dataset:
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":135
 *             nadds = 0
 *             i = 0
 *             for x,y in dataset:             # <<<<<<<<<<<<<<
 *                 xnnz = x.shape[0]
 ...
 */
    ...
    for (;;) {
      ...
      if (PyTuple_CheckExact(__pyx_t_6) && likely(PyTuple_GET_SIZE(__pyx_t_6) == 2)) {
        ...
        __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_12 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        ...
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_7 = __Pyx_UnpackItem(__pyx_t_1, 0); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        if (!(likely(((__pyx_t_7) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_7, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_t_4 = __Pyx_UnpackItem(__pyx_t_1, 1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_12 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        if (__Pyx_EndUnpack(__pyx_t_1, 2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(((PyObject *)__pyx_v_x));
        __pyx_v_x = ((PyArrayObject *)__pyx_t_7);
        __pyx_t_7 = 0;
      ...
      /* "bolt/trainer/avgperceptron.pyx":136
 *             i = 0
 *             for x,y in dataset:
 *                 xnnz = x.shape[0]             # <<<<<<<<<<<<<<
 *                 xdata = <Pair *>x.data
 ...
 */
      ...
      /* "bolt/trainer/avgperceptron.pyx":137
 *             for x,y in dataset:
 *                 xnnz = x.shape[0]
 *                 xdata = <Pair *>x.data             # <<<<<<<<<<<<<<
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 ...
 */
      __pyx_v_xdata = ((struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *)__pyx_v_x->data);

      /* "bolt/trainer/avgperceptron.pyx":138
 *                 xnnz = x.shape[0]
 *                 xdata = <Pair *>x.data
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)             # <<<<<<<<<<<<<<
 *                 u = <double>(E*n - (n*e+i+1))
 *                 if z != y:
 */
      __pyx_v_z = __pyx_f_4bolt_7trainer_13avgperceptron_argmax(__pyx_v_wdata, __pyx_v_wstride, __pyx_v_xdata, __pyx_v_xnnz, ((int)__pyx_v_y), __pyx_v_k);

      /* "bolt/trainer/avgperceptron.pyx":139
 *                 xdata = <Pair *>x.data
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 *                 u = <double>(E*n - (n*e+i+1))             # <<<<<<<<<<<<<<
 *                 if z != y:
 ...
 */
      ...
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_v_u = __pyx_t_13;

      /* "bolt/trainer/avgperceptron.pyx":140
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 *                 u = <double>(E*n - (n*e+i+1))
 *                 if z != y:             # <<<<<<<<<<<<<<
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 ...
 */
      ...
      if (__pyx_t_10) {
        ...
        /* "bolt/trainer/avgperceptron.pyx":141
 *                 u = <double>(E*n - (n*e+i+1))
 *                 if z != y:
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)             # <<<<<<<<<<<<<<
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)
 *                     nadds += 1
 */
        __pyx_f_4bolt_7trainer_13avgperceptron_add(__pyx_v_wdata, __pyx_v_wstride, __pyx_v_xdata, __pyx_v_xnnz, ((int)__pyx_v_y), 1.0, __pyx_v_wbardata, __pyx_v_u);

        /* "bolt/trainer/avgperceptron.pyx":142
 *                 if z != y:
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)             # <<<<<<<<<<<<<<
 *                     nadds += 1
 * 
 */
        __pyx_f_4bolt_7trainer_13avgperceptron_add(__pyx_v_wdata, __pyx_v_wstride, __pyx_v_xdata, __pyx_v_xnnz, __pyx_v_z, -1.0, __pyx_v_wbardata, __pyx_v_u);

        /* "bolt/trainer/avgperceptron.pyx":143
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)
 *                     nadds += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "bolt/trainer/avgperceptron.pyx":145
 *                     nadds += 1
 * 
 *                 i += 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":147
 *                 i += 1
 *             # report epoche information
 *             if verbose > 0:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_10) {
      ...
      /* "bolt/trainer/avgperceptron.pyx":148
 *             # report epoche information
 *             if verbose > 0:
 *                 print("NADDs: %d; NNZs: %d. " % (nadds, w.nonzero()[0].shape[0]))             # <<<<<<<<<<<<<<
 *                 print("Total training time: %.2f seconds." % (time()-t1))
 ...
 */
      ...
      /* "bolt/trainer/avgperceptron.pyx":149
 *             if verbose > 0:
 *                 print("NADDs: %d; NNZs: %d. " % (nadds, w.nonzero()[0].shape[0]))
 *                 print("Total training time: %.2f seconds." % (time()-t1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":152
 * 
 *         # floating-point under-/overflow check.
 ...
 */
  ...
  if (__pyx_t_15) {
    ...
    /* "bolt/trainer/avgperceptron.pyx":153
 *         # floating-point under-/overflow check.
 *         if np.any(np.isinf(w)) or np.any(np.isnan(w)):
 *             raise ValueError("floating-point under-/overflow occured.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":155
 *             raise ValueError("floating-point under-/overflow occured.")
 * 
 *         model.W = wbar * (1.0 / (n*E))             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_WriteUnraisable("bolt.trainer.avgperceptron.AveragedPerceptron._train_multi");
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_w);
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_wbar);
...
static struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron __pyx_vtable_4bolt_7trainer_13avgperceptron_AveragedPerceptron;

static PyObject *__pyx_tp_new_4bolt_7trainer_13avgperceptron_AveragedPerceptron(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *p;
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  p = ((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)o);
  p->__pyx_vtab = __pyx_vtabptr_4bolt_7trainer_13avgperceptron_AveragedPerceptron;
  return o;
}

static void __pyx_tp_dealloc_4bolt_7trainer_13avgperceptron_AveragedPerceptron(PyObject *o) {
  (*Py_TYPE(o)->tp_free)(o);
}

static PyMethodDef __pyx_methods_4bolt_7trainer_13avgperceptron_AveragedPerceptron[] = {
  {__Pyx_NAMESTR("train"), (PyCFunction)__pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train)},
  {0, 0, 0, 0}
};
...
static PyTypeObject __pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("bolt.trainer.avgperceptron.AveragedPerceptron"), /*tp_name*/
  sizeof(struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_4bolt_7trainer_13avgperceptron_AveragedPerceptron, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_4bolt_7trainer_13avgperceptron_AveragedPerceptron, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_4bolt_7trainer_13avgperceptron_AveragedPerceptron, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#endif
{
  ...
  if (__pyx_module_is_main_bolt__trainer__avgperceptron) {
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_4bolt_7trainer_13avgperceptron_AveragedPerceptron = &__pyx_vtable_4bolt_7trainer_13avgperceptron_AveragedPerceptron;
  __pyx_vtable_4bolt_7trainer_13avgperceptron_AveragedPerceptron._train_multi = (void (*)(struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *))__pyx_f_4bolt_7trainer_13avgperceptron_18AveragedPerceptron__train_multi;
  if (PyType_Ready(&__pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    PyObject *wrapper = __Pyx_GetAttrString((PyObject *)&__pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron, "__init__"); if (unlikely(!wrapper)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (Py_TYPE(wrapper) == &PyWrapperDescr_Type) {
      __pyx_wrapperbase_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__ = *((PyWrapperDescrObject *)wrapper)->d_base;
      __pyx_wrapperbase_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__.doc = __pyx_doc_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__;
      ((PyWrapperDescrObject *)wrapper)->d_base = &__pyx_wrapperbase_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__;
    }
  }
  if (__Pyx_SetVtable(__pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron.tp_dict, __pyx_vtabptr_4bolt_7trainer_13avgperceptron_AveragedPerceptron) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "AveragedPerceptron", (PyObject *)&__pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4bolt_7trainer_13avgperceptron_AveragedPerceptron = &__pyx_type_4bolt_7trainer_13avgperceptron_AveragedPerceptron;
  /*--- Type import code ---*/
  ...
  /* "bolt/trainer/avgperceptron.pyx":12
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":13
 * 
 * import numpy as np
 * import sys             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":18
 * cimport cython
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":20
 * from time import time
 * 
 * __authors__ = "Peter Prettenhofer <peter.prettenhofer@gmail.com>"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":1
 * # encoding: utf-8             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init bolt.trainer.avgperceptron");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bolt.trainer.avgperceptron");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
