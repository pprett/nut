"""Feature and history detectors for German:

It does not use part-of-speech, lemmas, and noun-phrase information provided by
CoNLL03.
...
It uses the following feature templates:
  ...
  * word shape (title, upper, hyphen, mixedcase, abstract cases)
  * word pre-/suffixes (from 1 to 4 chars)
  * preceeding tags (i-1 and i-2)
  * preceeding tag + current word
  * brown clusters (320 clusters; 4, 6, 10, 20 prefixes)
  * trigger words for person names (Frau, Herr, etc.)
  * gazetteers (first names, places, organizations)
